<?php
// This file is included by AdminController::usersAdd()
// Variables available: $pdo, $errors, $username, $email, $full_name, $role, $status, $page_title
?>
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fas fa-info-circle text-info"></i> Mật khẩu tối thiểu 6 ký tự</li>
                                <li><i class="fas fa-info-circle text-info"></i> Quản trị viên có toàn quyền truy cập</li>
                            </ul>
                        </div>
                    </div>
                </div>
