    ...
    <div class="row">
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-info">
          ...
          <a href="/admin/articles" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-6">
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <canvas id="articlesChart" style="height: 250px;"></canvas>
          </div>
        </div>
      </div>
      <div class="col-lg-6">
      ...
      <section class="col-lg-7 connectedSortable">
        ...
        <div class="card">
            ...
            <ul class="products-list product-list-in-card pl-2 pr-2">
              ...
              <li class="item">
                <div class="product-img">
                  <img src="<?= $article['image'] ?>" alt="Article Image" class="img-size-50">
                </div>
                <div class="product-info">
                  <a href="/admin/articles/edit/<?= $article['id'] ?>" class="product-title">
                    <?= htmlspecialchars($article['title']) ?>
                    <span class="badge badge-info float-right"><?= $article['category_name'] ?></span>
                  </a>
          ...
          <div class="card-footer text-center">
            <a href="/admin/articles" class="uppercase">View All Articles</a>
          </div>
          <!-- /.card-footer -->
        </div>
        <!-- /.card -->
          ...
          <div class="card-body">
            ...
            <div class="post">
              <div class="user-block">
                <img class="img-circle img-bordered-sm" src="<?= $comment['user_avatar'] ?>" alt="user image">
                <span class="username">
                  <a href="#"><?= htmlspecialchars($comment['user_name']) ?></a>
                </span>
                <span class="description">Posted on <?= date('M d, Y', strtotime($comment['created_at'])) ?></span>
              </div>
              <!-- /.user-block -->
              <p><?= htmlspecialchars($comment['content']) ?></p>
              <p>
                <a href="/admin/comments/edit/<?= $comment['id'] ?>" class="link-black text-sm">
                  <i class="fas fa-edit mr-1"></i> Edit
                </a>
                <a href="/admin/comments/delete/<?= $comment['id'] ?>" class="link-danger text-sm" onclick="return confirm('Are you sure?')">
